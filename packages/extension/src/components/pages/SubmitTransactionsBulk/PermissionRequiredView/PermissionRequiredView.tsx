...
interface PermissionRequiredViewProps {
  ...
  transactionStatusComponent: React.ReactNode;
}
          ...
          <div style={{ marginBottom: '40px' }}>
            ...
            <div style={{ marginTop: '5px', marginBottom: '15px' }}>
              <Typography variant="body2" color="textSecondary" style={{ marginTop: '10px' }}>
                The bulk transactions submission permission is currently disabled. You need to
                enable it in order to continue.
              </Typography>
              <Typography variant="body2" color="textSecondary" style={{ marginTop: '10px' }}>
                Enabling this permission will allow the system to submit multiple transactions in
                bulk. This is a powerful feature and should be used responsibly.
              </Typography>
            ...
            >
              ...
              >
                ...
                <Button
                  onClick={enableBulkTransactionPermission}
                  variant="contained"
                  color="primary"
                >
                  Enable Permission
