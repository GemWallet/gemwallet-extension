...
describe('convertHexCurrencyString', () => {
  it('should convert a currency string with 40 characters into its corresponding characters', () => {
    ...
    const expected = 'SOLO';
    expect(convertHexCurrencyString(currency)).toMatch(expected);
  });

  it('should return the original currency string if it does not have 40 characters', () => {
    const currency = 'USD';
    expect(convertHexCurrencyString(currency)).toEqual(currency);
  });
  ...
  it('should convert a valid currency code with mixed case', () => {
    ...
    const expected = 'bTc';
    expect(convertHexCurrencyString(currency)).toEqual(expected);
  });
  ...
  it('should convert a valid currency with all authorized characters', () => {
    ...
    const expected2 = '&*()<>(){}[]';
    expect(convertHexCurrencyString(currency2)).toMatch(expected2);
    //
  });
});
